    ...
    <div class="row">
      <div class="col-sm-4">
        ...
        <a href="https://www.youtube.com/playlist?list=PLN9r3gitIiJ65fDDtjgKvc2RFqA78OykW" target="_blank">
            <img src="<?= site_url('assets/site/'); ?>img/img_41.png" alt="" class="img_r">
      ...
      <div class="col-sm-4">
        ...
        <a href="https://www.youtube.com/watch?v=8efVSL835Mc&list=PLN9r3gitIiJ751TwsaWnppSSs93BJDgqR&index=1" target="_blank">
            <img src="<?= site_url('assets/site/'); ?>img/img_42.png" alt="" class="img_r">
      ...
      <div class="col-sm-4">
        ...
        <a href="https://www.youtube.com/watch?v=ckxmM0ZmTrQ&list=PLN9r3gitIiJ6XzyEsmrv34qwSap98TYXf" target="_blank">
            <img src="<?= site_url('assets/site/'); ?>img/img_43.png" alt="" class="img_r">
  ...
  <div class="container">
    ...
    <div class="row" >
      ...
      <div class="col-md-4"   >
        <div class="blog_1">
          <a href="#" >
            <img src="<?= site_url('assets/site/'); ?>img/img_8.jpg">
            <div class="blog_2">
      ...
      <div class="col-md-4"   >
        <div class="blog_1">
          <a href="#" >
            <img src="<?= site_url('assets/site/'); ?>img/img_9.jpg">
            <div class="blog_2">
              <h5><i class="fa fa-user"></i> Admin <i class="fa fa-calendar"></i>8 Fub 2022</h5>
              <h4>
      ...
      <div class="col-md-4"   >
        <div class="blog_1">
          <a href="#" >
            <img src="<?= site_url('assets/site/'); ?>img/img_14.jpg">
            <div class="blog_2">
